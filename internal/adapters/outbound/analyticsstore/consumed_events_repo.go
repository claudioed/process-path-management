...
// consumer's dedupe set, kept separate from the projection's own
// event-id claim (analytics_processed_events) so the two idempotency
// layers do not race for the same row.
